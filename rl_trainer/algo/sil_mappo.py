'''
    implementation of MAPPO with self imitation learning
    modified from mappo.py
    add SILReplayBuffer and sil_update function
'''
...
class MAPPO:
    ...
    def __init__(self, obs_dim, act_dim, num_agent, args):
        ...
        self.sil_batch_size = args.sil_batch_size
        self.eps = 0
        ...
        self.sil_buffer = SILReplayBuffer(args.buffer_size, args.sil_batch_size)
    ...
    def sil_update(self):
        state_batch, action_batch, reward_batch, next_state_batch, done_batch = self.sil_buffer.get_batches()

        state_batch = torch.Tensor(state_batch).reshape(self.sil_batch_size, self.num_agent, -1).to(self.device)
    ...
    def update(self, batch):
        ...
        self.sil_buffer.push_batch(state_batch, action_batch, reward_batch, next_state_batch, done_batch, global_state_batch)
