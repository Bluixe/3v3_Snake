'''
    trainning code for mappo with self imitation learning
...
from algo.sil_mappo import MAPPO
from common import *
...
if __name__ == '__main__':
    ...
    '''
        batch size of sil for each iteration
    '''
    parser.add_argument('--sil_batch_size', default=4800, type=int)
